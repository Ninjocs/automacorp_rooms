...
import com.example.automacorp.ui.RoomListActivity
    ...
    val actions: @Composable RowScope.() -> Unit = {
        ...
        IconButton(onClick = {
            val intent = Intent(Intent.ACTION_SENDTO).apply {
                ...
                putExtra(Intent.EXTRA_EMAIL, arrayOf("timothee.lardy@etu.emse.com"))
                putExtra(Intent.EXTRA_SUBJECT, "Automacorp Inquiry") }
            context.startActivity(intent)
            }) {
            Icon(
        ...
        IconButton(onClick = {
            val githubIntent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/Ninjocs"))
